...
class TransactionsListTable extends WP_List_Table
{
    ...
    public function get_columns()
    {
        $columns = array(
            ...
            'ID'             => __('ID заказа', 'yandex-money-checkout'),
            'transaction_id' => __('ID платежа', 'yandex-money-checkout'),
            'post_status'    => __('Статус', 'yandex-money-checkout'),
            'post_title'     => __('Описание заказа', 'yandex-money-checkout'),
        );
    ...
    {
        $actions = array(
            'capture' => __('Провести платежи', 'yandex-money-checkout'),
        );
