...
class YandexMoneyGatewayCard extends YandexMoneyCheckoutGateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_description     = __('Оплата с произвольной банковской карты', 'yandex-money-checkout');
        $this->method_title           = __('Банковские карты', 'yandex-money-checkout');

        $this->defaultTitle           = __('Банковские карты — Visa, Mastercard и Maestro, «Мир»', 'yandex-money-checkout');
        $this->defaultDescription     = __('Оплата с произвольной банковской карты', 'yandex-money-checkout');
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields['save_payment_method'] = array(
            ...
            'type'    => 'checkbox',
            'label'   => __('Покупатели могут сохранять карту для повторной оплаты', 'yandex-money-checkout'),
            'default' => 'no',
        );
    }
